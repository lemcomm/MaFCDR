...
class LoadDungeonMonsters extends AbstractFixture implements OrderedFixtureInterface {
	...
	private $monsters = array(
		...
		'monhunter'	=> array('power' => 90, 'attacks' =>  1, 'defense' => 45, 'wounds' => 2, 'mindepth' => 4, 'class' => array('human', 'ranged', 'group', 'swim', 'poison'), 'areas' => array('cave', 'ruin', 'dungeon', 'lab', 'wild', 'glade', 'citadel')),
		'npcdungeoneer'	=> array('power' => 65, 'attacks' =>  1, 'defense' => 80, 'wounds' => 3, 'mindepth' => 4, 'class' => array('human', 'melee', 'group', 'swim'), 'areas' => array('cave', 'ruin', 'dungeon', 'lab', 'wild', 'glade', 'citadel')),
